...
fn main() {
    ...
    let window_name = format!("{}-{}/{}", app_name, cli.task_type, cli.task_name);
    let branch_name = format!("{}/{}", cli.task_type, cli.task_name);
    let worktree_name = format!("{}-{}", app_name, cli.task_name);
